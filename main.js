...
async function blink(item, missingV) {
    ...
    //document.getElementById(item).style.animation = "blinkingBackground 2s 1";
    await sleep(2650);
...
async function blinkVal(item) {
    ...
    for(let h = 1; h <= 9; h++) {
        if(document.getElementById("row-" + aIter).getElementsByClassName("layer-" + h)[0].innerText === item) {
            ...
            document.getElementById("row-" + aIter).style.animation = "blinkingBackgroundThree 3s 1";
        }
        if(document.getElementById("row-" + bIter).getElementsByClassName("layer-" + h)[0].innerText === item) {
            ...
            document.getElementById("row-" + bIter).style.animation = "blinkingBackgroundThree 3s 1";
        }
        if(document.getElementById("row-" + cIter).getElementsByClassName("layer-" + h)[0].innerText === item) {
            ...
            document.getElementById("row-" + cIter).style.animation = "blinkingBackgroundThree 3s 1";
        }
    ...
    console.log(valId);
    await sleep(200)
    document.getElementById(valId[0]).style.animation = "blinkingBackground 2.5s 1";

    document.getElementById(valId[1]).style.animation = "blinkingBackground 2.5s 1";
    await sleep(3000);
...
async function blinkTarget(item) {
    ...
    if(document.getElementById(item[0]).innerText === '') {
        document.getElementById(item[0]).style.animation = "blinkingBackgroundTwo 3s 1";
    }
    if(document.getElementById(item[1]).innerText === '') {
        document.getElementById(item[1]).style.animation = "blinkingBackgroundTwo 3s 1";
    }
    if(document.getElementById(item[2]).innerText === '') {
        document.getElementById(item[2]).style.animation = "blinkingBackgroundTwo 3s 1";
    }
    await sleep(1000);
...
async function blinkValCol(item) {
    ...
    for(let h = 1; h <= 9; h++) {
        if(document.getElementById("row-" + h).getElementsByClassName("layer-" + aIter)[0].innerText == item) {
            ...
            document.getElementById("col-" + aIter).style.animation = "blinkingBackgroundThree 3s 1";
        }
        if(document.getElementById("row-" + h).getElementsByClassName("layer-" + bIter)[0].innerText == item) {
            ...
            document.getElementById("col-" + bIter).style.animation = "blinkingBackgroundThree 3s 1";
        }
        if(document.getElementById("row-" + h).getElementsByClassName("layer-" + cIter)[0].innerText == item) {
            ...
            document.getElementById("col-" + cIter).style.animation = "blinkingBackgroundThree 3s 1";
        }
